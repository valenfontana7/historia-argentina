...
const cronicasBase: CronicaBase[] = [
  ...
  },
  {
    ...
    titulo: "Cristina",
    subtitulo:
      "2007 a 2015: Resolución 125, cepo, YPF y la Argentina polarizada.",
    kicker: "Crónica N.º 46 · La Argentina contemporánea",
    periodo: "2007 a 2015",
    duracion: "10 minutos",
    descripcion:
      "Cristina Fernández: del boom de commodities a la grieta del campo, el cepo y la derrota de 2015.",
    publicada: "2026-07-11",
    acceso: "publico",
    protagonista: { slug: "juan-domingo-peron", etiqueta: "La ficha de Perón" },
  ...
  },
  {
    ...
    titulo: "Macri",
    subtitulo:
      "2015 a 2019: apertura, holdouts, stand-by con el FMI y derrota electoral.",
    kicker: "Crónica N.º 47 · La Argentina contemporánea",
    periodo: "2015 a 2019",
    duracion: "10 minutos",
    descripcion:
      "Mauricio Macri y Cambiemos: gradualismo, deuda, el stand-by de 2018 y el retorno del peronismo.",
    publicada: "2026-07-11",
    acceso: "publico",
    protagonista: { slug: "juan-domingo-peron", etiqueta: "La ficha de Perón" },
  ...
  },
  {
    ...
    subtitulo:
      "2019 a 2023: Frente de Todos, pandemia, FMI y la grieta que abrió la puerta a Milei.",
    kicker: "Crónica N.º 50 · La Argentina contemporánea",
    periodo: "2019 a 2023",
    duracion: "10 minutos",
    descripcion:
      "Alberto Fernández: pandemia, deuda con el FMI, tensión con Cristina y Massa, y la derrota de 2023.",
    publicada: "2026-07-11",
    acceso: "publico",
    protagonista: { slug: "juan-domingo-peron", etiqueta: "La ficha de Perón" },
  ...
  },
  {
    ...
    titulo: "Milei",
    subtitulo:
      "2023 a julio de 2026: motosierra, Ley Bases, legislativas y un experimento aún abierto.",
    kicker: "Crónica N.º 51 · La Argentina contemporánea",
    periodo: "2023 a julio de 2026",
    duracion: "12 minutos",
    descripcion:
      "Javier Milei: del balotaje de 2023 al corte editorial del 16 de julio de 2026.",
    publicada: "2026-07-11",
    acceso: "publico",
    protagonista: { slug: "juan-bautista-alberdi", etiqueta: "La ficha de Alberdi" },
  ...
  {
    slug: "el-acuerdo-con-el-fmi",
    titulo: "El acuerdo con el FMI",
    subtitulo:
      "2020 a 2022: la deuda heredada, Guzmán y el Fondo bajo el Frente de Todos.",
    kicker: "Crónica N.º 53 · La Argentina contemporánea",
    periodo: "2020 a 2022",
    duracion: "8 minutos",
    descripcion:
      "El stand-by de 2018, la renegociación con acreedores y el acuerdo con el FMI que tensionó al peronismo.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "juan-domingo-peron", etiqueta: "La ficha de Perón" },
    visual: { varianteHero: "mayo", imagenHero: "fmi-sede" },
  },
  {
    slug: "ley-bases",
    titulo: "La Ley Bases",
    subtitulo:
      "2023 a 2024: del DNU de desregulación a la primera gran ley del gobierno de Milei.",
    kicker: "Crónica N.º 54 · La Argentina contemporánea",
    periodo: "2023 a 2024",
    duracion: "8 minutos",
    descripcion:
      "Cómo Milei pasó del decreto al Congreso: el ómnibus, la negociación y la sanción de la Ley Bases.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "juan-bautista-alberdi", etiqueta: "La ficha de Alberdi" },
    visual: { varianteHero: "mayo", imagenHero: "congreso-nacion" },
  },
  {
    slug: "legislativas-2025",
    titulo: "Las legislativas de 2025",
    subtitulo:
      "Octubre de 2025: el veredicto de medio término sobre el ajuste libertario.",
    kicker: "Crónica N.º 55 · La Argentina contemporánea",
    periodo: "2025",
    duracion: "8 minutos",
    descripcion:
      "La Libertad Avanza crece en bancas y refuerza el mandato reformista de Milei.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "juan-bautista-alberdi", etiqueta: "La ficha de Alberdi" },
    visual: { varianteHero: "mayo", imagenHero: "milei-retrato-oficial" },
  },
  {
    slug: "carapintadas",
    titulo: "Los Carapintadas",
    subtitulo:
      "1987 a 1990: Semana Santa, Villa Martelli y el límite militar a la transición.",
    kicker: "Crónica N.º 68 · La Argentina contemporánea",
    periodo: "1987 a 1990",
    duracion: "8 minutos",
    descripcion:
      "Los alzamientos carapintadas, las leyes de Punto Final y Obediencia Debida, y el camino a los indultos.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "raul-alfonsin", etiqueta: "La ficha de Alfonsín" },
    visual: { varianteHero: "mayo", imagenHero: "transicion-alfonsin" },
  ...
  {
    slug: "reforma-94",
    titulo: "La Reforma del 94",
    subtitulo:
      "1993 a 1994: Pacto de Olivos, reelección y las reglas que todavía usamos.",
    kicker: "Crónica N.º 69 · La Argentina contemporánea",
    periodo: "1993 a 1994",
    duracion: "8 minutos",
    descripcion:
      "Cómo Menem y Alfonsín reescribieron la Constitución: balotaje, mandato corto y Jefe de Gabinete.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "juan-domingo-peron", etiqueta: "La ficha de Perón" },
    visual: { varianteHero: "mayo", imagenHero: "constitucion-1853" },
  },
  {
    slug: "duhalde",
    titulo: "Duhalde",
    subtitulo:
      "2002 a 2003: pesificación, emergencia y el puente del 2001 a Kirchner.",
    kicker: "Crónica N.º 70 · La Argentina contemporánea",
    periodo: "2002 a 2003",
    duracion: "8 minutos",
    descripcion:
      "Eduardo Duhalde: administrar el default, enterrar el 1 a 1 y anticipar la elección que trajo a Néstor.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "juan-domingo-peron", etiqueta: "La ficha de Perón" },
    visual: { varianteHero: "mayo", imagenHero: "duhalde-retrato" },
  },
  {
    slug: "resolucion-125",
    titulo: "La Resolución 125",
    subtitulo:
      "2008: el conflicto del campo que convirtió retenciones en grieta nacional.",
    kicker: "Crónica N.º 71 · La Argentina contemporánea",
    periodo: "2008",
    duracion: "8 minutos",
    descripcion:
      "De la Resolución 125 al voto no positivo de Cobos: el ensayo general de la polarización K.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "juan-domingo-peron", etiqueta: "La ficha de Perón" },
    visual: { varianteHero: "pampa", imagenHero: "campo-argentino" },
  },
  {
    slug: "stand-by-2018",
    titulo: "El stand-by de 2018",
    subtitulo:
      "2018 a 2019: el préstamo récord del FMI bajo Macri y la herencia que siguió.",
    kicker: "Crónica N.º 72 · La Argentina contemporánea",
    periodo: "2018 a 2019",
    duracion: "8 minutos",
    descripcion:
      "La corrida, el stand-by más grande de la historia del Fondo y el prólogo del acuerdo de Alberto.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "juan-bautista-alberdi", etiqueta: "La ficha de Alberdi" },
    visual: { varianteHero: "mayo", imagenHero: "fmi-sede" },
  },
  {
    ...
    titulo: "Argentina–Inglaterra 2026",
    subtitulo:
      "Atlanta, 15 de julio: el 2–1 a Inglaterra, Malvinas en la tribuna y la final abierta contra España.",
    kicker: "Crónica N.º 73 · Cultura argentina",
    periodo: "15 a 19 de julio de 2026",
    duracion: "9 minutos",
    descripcion:
      "Semifinal del Mundial 2026: Argentina remonta a Inglaterra, la memoria de 1982 late en la tribuna y el 19 de julio queda por escribirse.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "raul-alfonsin", etiqueta: "La ficha de Alfonsín" },
    visual: { varianteHero: "mayo", imagenHero: "messi-2026-retrato" },
  },
  {
    slug: "mundial-1978",
    titulo: "Mundial 1978",
    subtitulo:
      "25 de junio de 1978: Kempes, la primera estrella y el Mundial bajo dictadura.",
    kicker: "Crónica N.º 74 · Cultura argentina",
    periodo: "junio de 1978",
    duracion: "8 minutos",
    descripcion:
      "La final ante Países Bajos, el Matador Kempes y la contradicción de celebrar bajo el Proceso.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "raul-alfonsin", etiqueta: "La ficha de Alfonsín" },
    visual: { varianteHero: "mayo", imagenHero: "kempes-1978" },
  },
  {
    slug: "mundial-1986",
    titulo: "Mundial 1986",
    subtitulo:
      "29 de junio de 1986: Maradona, Inglaterra y la segunda estrella en democracia.",
    kicker: "Crónica N.º 75 · Cultura argentina",
    periodo: "junio de 1986",
    duracion: "8 minutos",
    descripcion:
      "México 86: la Mano de Dios, el gol del siglo, la final ante Alemania y el 10 eterno.",
    publicada: "2026-07-16",
    acceso: "publico",
    protagonista: { slug: "raul-alfonsin", etiqueta: "La ficha de Alfonsín" },
    visual: { varianteHero: "mayo", imagenHero: "maradona-retrato" },
  },
  {
    slug: "piqueteros",
...
export const cargadores: Record<string, () => Promise<{ default: ComponentType }>> = {
  ...
  "el-acuerdo-con-el-fmi": () => import("@/content/cronicas/el-acuerdo-con-el-fmi.mdx"),
  "ley-bases": () => import("@/content/cronicas/ley-bases.mdx"),
  "legislativas-2025": () => import("@/content/cronicas/legislativas-2025.mdx"),
  carapintadas: () => import("@/content/cronicas/carapintadas.mdx"),
  "reforma-94": () => import("@/content/cronicas/reforma-94.mdx"),
  duhalde: () => import("@/content/cronicas/duhalde.mdx"),
  "resolucion-125": () => import("@/content/cronicas/resolucion-125.mdx"),
  "stand-by-2018": () => import("@/content/cronicas/stand-by-2018.mdx"),
  "argentina-inglaterra-2026": () =>
    import("@/content/cronicas/argentina-inglaterra-2026.mdx"),
  "mundial-1978": () => import("@/content/cronicas/mundial-1978.mdx"),
  "mundial-1986": () => import("@/content/cronicas/mundial-1986.mdx"),
