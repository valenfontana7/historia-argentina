...
<VitrinaContexto
  tipo="pieza"
  slug="julio-congreso"
  puente="La pintura del Congreso de Tucumán que declaró la independencia."
/>
...
<IlustracionEscena
  ...
  pie="Belgrano en el Congreso: la voz militar que empujó la declaración"
  formato="retrato"
/>
...
<IlustracionEscena
  imagenId="mayo-junta"
  pie="De la Junta de 1810 al Acta de 1816: el largo camino a escribir la independencia"
/>
